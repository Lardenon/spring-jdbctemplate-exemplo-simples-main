...
public class JdbctemplateApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("O número de contatos na tabela é: "+rowCount);

		int telefone = this.jdbcTemplate.queryForObject(
        "SELECT telefone FROM contatos WHERE nome = ?", Integer.class, "Edson Angoti Júnior");
